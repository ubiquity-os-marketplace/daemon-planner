...
2. Update [dispatch.yml](./.github/workflows/dispatch.yml) with your plugin's name and update the `id`.
...
- The `dispatch.yml` workflow will run and execute your plugin's logic.
